...
class Swin(BaseModule):
    ...
    def __init__(self,
        ...
        self.patch_embed_lidar = PatchEmbed(in_channels=in_channels,
                                            embed_dims=embed_dims,
                                            conv_type='Conv2d',
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            ckpt = CheckpointLoader.load_checkpoint(ckpt, logger=logger, map_location='cpu')
            ...
            for table_key in relative_position_bias_table_keys:
                ...
                if nH1 != nH2:
                    ...
                    S1 = int(L1**0.5)
                    S2 = int(L2**0.5)
                    table_pretrained_resized = F.interpolate(table_pretrained.permute(1, 0).reshape(1, nH1, S1, S1),
                                                             size=(S2, S2),
                                                             mode='bicubic')
            ...
            print('swin transformer init_finished')
