...
class Cond_Diffusion(nn.Module):
    def __init__(self, num_classes = 20, diffusion_steps = 100):
        super(Cond_Diffusion, self).__init__()
    ...
    def q_posterior(self, log_x_start, log_x_t, t):
        ...
        return log_EV_xtmin_given_xt_given_xstart  # return log q(xt-1 | xt, x0)
    ...
    def forward(self, x):
        ...
        log_x_t = self.q_sample(log_x_start, t) # log_x_t : (1, 20, 256, 256, 32)

        log_true_prob = self.q_posterior(log_x_start=log_x_start, log_x_t=log_x_t, t=t)

        print(log_true_prob.size())
        return None

if __name__ == '__main__':
    # python /u/home/caoh/projects/MA_Jiachen/3DPNA/projects/model/diffusion/cond_diffusion.py

    CD = Cond_Diffusion().cuda()
