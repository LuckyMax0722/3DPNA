...
from cores.loss.metric_torch import SSCMetrics
from cores.loss.utils import get_inv_map
...
class pl_model_pna_text(pl.LightningModule):
    ...
    def forward_train(self, data_dict):
        ...
        elif self.model_version == 'pna':
            output_PNA = self.model(input_occ)
        ...
        elif self.model_version == 'text':
            output_TEXT = self.model(input_occ, data_dict['text_feat'])
    ...
    def on_train_batch_end(self, outputs, batch, batch_idx):
        ...
        if self.debug:
            ...
            print(f"Reserved_GB: {reserved_GB:.2f} GB")
