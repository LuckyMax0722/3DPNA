...
class LSegmentationModule(pl.LightningModule):
    ...
    def get_trainset(self, dset, augment=False, **kwargs):
        ...
        #self.train_accuracy = torchmetrics.Accuracy(task='multiclass', num_classes=self.nclass)

        return dset

    def get_valset(self, dset, augment=False, **kwargs):

        #self.val_accuracy = torchmetrics.Accuracy(task='multilabel', num_classes=self.nclass)
